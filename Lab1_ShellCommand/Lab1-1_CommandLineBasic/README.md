...
## 6.1 grep 指定された文字(パターン)を含む行を抽出する
...
リモートサーバーがLunix系のサーバーであれば、今まで学習したコマンドをリモートサーバー嬢でも実行できます。
...
manコマンドは英語なので、日本語で知りたい場合は、Web検索エンジンで調べればいくらでも出てきます。いろいろなオプションも試してみましょう。
