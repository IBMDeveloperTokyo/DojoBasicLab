...
viの上位互換ツールとしてVimというものが存在する。MacやLinuxなどのUnix系OSには標準でVimがインストールされていることが多い。ここでは、Vimとviの詳細な違いについては解説しないが、Vimではviの機能はほとんど使うことができるので、viの操作を覚えるつもりで読み進めて頂けるとありがたい。
